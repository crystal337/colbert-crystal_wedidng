...
export function PassportCover({ onOpen }: { onOpen: () => void }) {
  return (
    <motion.div
      ...
      className="flex min-h-svh w-full flex-col items-center justify-center gap-8 px-6 py-12"
    >
      <div className="relative flex aspect-[5/7] w-full max-w-[22rem] flex-col items-center justify-between rounded-2xl border border-passport-gold/40 bg-passport-green px-6 py-8 text-passport-gold shadow-[0_20px_60px_-15px_rgba(10,36,25,0.6)] sm:max-w-sm">
        {/* faux leather sheen */}
      ...
      <motion.button
        ...
        className="rounded-full bg-passport-gold px-10 py-3 text-passport-green shadow-lg shadow-passport-gold/30"
      >
        <BiText
